  ...
  return (
    <>
      <Breadcrumb>
        ...
        {editStaff && (
          <Breadcrumb.Item>
            <Link className="staff-name" to={`/admin/partners/communities/${id}/staff/${staffId}`}>{`${humanize(editStaff.name)}`}</Link>
          </Breadcrumb.Item>
        )}
      </Breadcrumb>
      <PageHeader className="site-page-header staff-name" title={editStaff && `${humanize(editStaff.name)}`} />
        ...
        {editStaff && (
          ...
          <Row gutter={30}>
            <Col xs={24} sm={24} md={8} lg={8} xl={8}>
              ...
              >
                <Meta className="staff-name" title={humanize(editStaff.name)} />
              </Card>
            </Col>
